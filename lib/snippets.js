...
{"summary":"One sentence: what this script does","issues":["specific issue 1"],"fixedCode":"complete corrected script","whatChanged":["change 1 + brief reason"]}

If no issues exist, return empty arrays and return the original code unchanged.
Be specific — say exactly what line or pattern is wrong and why.`;
